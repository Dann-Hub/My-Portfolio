...
export default function About() {
    return (
        <section id="about" className="min-h-screen relative overflow-hidden py-32">
            ...
            <div className="mx-auto max-w-6xl  px-6 grid grid-cols-1 justify-items-center gap-12 mt-14 lg:grid-cols-[7fr_3fr] lg:justify-items-stretch">
                <div className="">
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 mt-9 text-justify leading-loose">
                        <div className=" ">
                            <p>
                                I am a results-oriented professional with a strong foundation in Electrical/Electronic
                                Engineering,
                                holding a BSc in the field, complemented by experience in Systems Management.<br/><br/>
                                From serving as a District Manager for the Ghana Statistical Service to leading projects
                                for the Ghana
                                Institution of Engineering (Students’ Chapter), I have balanced high-level operational
